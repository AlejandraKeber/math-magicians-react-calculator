...
**[Math-Magicians-React-Calculator]** is a a Single Page App (SPA) that allows users to:
...
```sh
  cd my-folder
  git clone https://github.com/AlejandraKeber/math-magicians-react-calculator.git
```
...
Feel free to check the [issues page](https://github.com/AlejandraKeber/math-magicians-react-calculator/issues).
